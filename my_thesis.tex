...
\include{main/ch1_game_design}
\include{main/ch2_architecture}
\include{main/ch3_user_comfort_improvement}
\include{main/ch4_questions_difficulty}
\include{main/ch5_pilots}
